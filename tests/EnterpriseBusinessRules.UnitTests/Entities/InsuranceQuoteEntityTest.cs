...
        {
            var insuranceQuoteEntity = CreateInsuranceQuoteEntity();
            
            insuranceQuoteEntity.Input.Should().Equals(_input);
            insuranceQuoteEntity.Input.Should().BeOfType<InsuranceQuoteInputEntity>();
            insuranceQuoteEntity.Product.Should().Equals(_product);
            insuranceQuoteEntity.Product.Should().BeOfType<ProductEntity>();
            insuranceQuoteEntity.Settings.Should().BeOfType<QuotationSettingsEntity>();
            insuranceQuoteEntity.Should().NotBeNull();
            insuranceQuoteEntity.Should().BeOfType<InsuranceQuoteEntity>();
        }
        ...
        public void ValidateMethodShouldBeCalled()
        {
            ...
            insuranceQuoteEntity.Validate().IsValid.Should().BeTrue();
            insuranceQuoteEntity.Validate().Should().BeOfType<ValidationResult>();
        }
    }
}
